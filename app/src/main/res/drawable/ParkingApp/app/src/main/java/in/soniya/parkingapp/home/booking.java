...
public class booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent streamIntent = new Intent(booking.this, Detail_page.class);
    ...
    private void DeleteData() {
        ...
        db.collection("Book").document("Contacts")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(booking.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        DocumentReference contact = db.collection("Book").document("Contacts");
        contact.update(SLOT_KEY, "001");
        contact.update(VEHICLE_KEY, "Dcl-5656");
        contact.update(TIME_KEY, "4:56 PM");
        contact.update(PHONE_KEY, "+91 8999743930")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(booking.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void ReadSingleContact() {
        ...
        DocumentReference user = db.collection("Book").document("Contacts");
    ...
    private void addNewContact(){
        ...
        db.collection("Book").document("Contacts").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        AlertDialog alertDialog = new AlertDialog.Builder(booking.this).create();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(booking.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
