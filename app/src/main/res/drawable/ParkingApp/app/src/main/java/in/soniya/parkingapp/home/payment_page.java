...
public class payment_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText("Sanket Jadhav");
        upiId.setText("sanket.jadhav10@ybl");
        note.setText("car parking");
        amount.setText("10");
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    Toast.makeText(payment_page.this,"Fill all above details and try again.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(payment_page.this,"Google pay is not installed. Please install and try again.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(payment_page.this, "Transaction successful. "+approvalRefNo, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(payment_page.this, "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
