package com.example.imagesilderdialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        imageSilder = findViewById(R.id.imageSilder); // Your button to open the slider
    }
    ...
    private void openImageSliderDialog() {
        ...
        customDialog.setContentView(R.layout.my_image_silder);
